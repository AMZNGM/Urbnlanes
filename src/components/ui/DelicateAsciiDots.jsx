...
export default function DelicateAsciiDots({
  ...
  const CHARS = 'urbnlanes urbnlanes urbnlanes urbnlanes urbnlanes urbnlanes'
  ...
  return (
    <div ref={containerRef} className="top-1/2 left-1/2 absolute w-full h-full overflow-hidden -translate-1/2" style={{ backgroundColor }}>
