...
export default function PartnersCTA() {
  return (
    <section className="relative w-dvw overflow-hidden bg-bg text-text px-4 max-md:px-2">
      ...
      <AnimIn className="max-w-sm space-y-8 text-center mx-auto">
        ...
        <MainBtn href="mailto:partnerships@urbnlanes.com" tKey="nav.getInTouch" look="wideMonoDark" />
      </AnimIn>
