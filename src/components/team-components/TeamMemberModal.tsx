      ...
      {selectedMember && (
        ...
        >
          ...
          >
            ...
            <div style={{ scrollbarWidth: 'none' }} className="md:w-2/3 h-full md:overflow-y-auto flex flex-col justify-between gap-8">
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col">
                  ...
                  <AnimText className="opacity-50 text-xs text-center uppercase tracking-widest">
                    <TText tKey={`team.members.${selectedMember.id}.position`} />
                  </AnimText>
                </div>

                <div className="h-full overflow-y-auto max-md:text-center mt-4 mb-16">
                  <p className="opacity-75 text-sm text-balance leading-normal">
