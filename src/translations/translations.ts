export const TRANSLATIONS = {
  en: {
    ...
    common: {
      ...
      architecturalExcellenceDesc:
        'We create architectural wonders and masterpieces for our clients. With our team of experts, carefully selected top-notch partners, and international experts, we deliver the best architectural projects for our clients.',
    ...
    partners: {
      ...
      partnersNames: {
        ...
        'First United Group': 'First United Group',
        'First United': 'First United',
        Solo: 'Solo',
        'White Pearl': 'White Pearl',
        Urbnlanes: 'Urbnlanes',
        'Raef fahmi architects': 'Raef fahmi architects',
        'Delave Studio': 'Delave Studio',
        Tahseen: 'Tahseen',
        'HC Consultants': 'HC Consultants',
        'Oko Plan': 'Oko Plan',
        Etisalat: 'Etisalat',
    ...
    db: {
      ...
      whoweare: {
        ...
        statistics: [
          { title: 'Years Of Experience', value: '36+' },
          { title: 'Projects Completed', value: '100+' },
          { title: 'Towers Delivered', value: '20+' },
          { title: 'Workforce', value: '3,600+' },
          { title: 'Landmark Projects', value: '60+' },
        ],
        stats: [
        ...
        values: [
          ...
          },
          {
            title: 'Adherence',
            description:
              'Our demonstrated history and vast expertise give us the edge in delivery dates. Our sister companies in Kuwait built an impeccable track record of meeting deadlines.',
          },
          {
            title: 'Reliability',
            description:
              "Urbnlanes has redefined the clients' experience in the market and changed notions, by dint of sheer diligence and devotion to excellence.",
          },
          {
            title: 'Agility',
            description:
  ...
  ar: {
    ...
    common: {
      ...
      architecturalExcellence: 'تصميم وهيكلية متميزة',
      architecturalExcellenceDesc:
        'نحن نخلق أندون الهيكلية والتصميمية والمعروفة لعملائنا. مع فريق محترف من الخبراء وشركاء متميزين وخبراء دوليين، نقدم الأفضل مشاريع هيكلية لعملائنا.',
    ...
    partners: {
      ...
      partnersNames: {
        'First Group': 'فيرست جروب',
        'First United Group': 'فيرست يونايتد جروب',
        'First United': 'فيرست يونايتد',
        Solo: 'سولو',
        'White Pearl': 'وايت بيرل',
        Urbnlanes: 'أوربن لينز',
        'Raef fahmi architects': 'رائف فهمي',
        'Delave Studio': 'ديلافي استوديو',
        Tahseen: 'تحسين',
        'HC Consultants': 'اتش اس كونسالتانت',
        'Oko Plan': 'اوكا بلان',
        Etisalat: 'اتصالات',
        Whitespace: 'وايت اسبيس',
      },
      partnersRoles: {
        Partner: 'شريك',
        Planning: 'تخطيط',
    ...
    db: {
      metadata: {
        company: {
          title: 'اربن لينز',
          name: 'اربن لينز للتطوير العقاري',
      ...
      whoweare: {
        ...
        description:
          'تعمل شركة اربن لينز للتطوير العقاري تحت مظلة شركة إميل عبد الله للاستثمارات، مقدمة عقودًا من الخبرة إلى المشهد العقاري الديناميكي في الشرق الأوسط. محفظتنا المتنوعة والتزامنا الثابت بالجودة رسخ مكانتنا كاسم موثوق في مجال التطوير العقاري الفاخر.',
        description2:
          'اربن لينز هي شركة تطوير عقاري، تعمل تحت مظلة "إميل عبد الله للاستثمارات". مع مشاريع في جميع أنحاء الشرق الأوسط، هي شركة مبنية على التنوع وسنوات عديدة من الخبرة في مجال التطوير العقاري تعمل شركة اربن لينز للتطوير العقاري تحت مظلة شركة إميل عبد الله للاستثمارات، مقدمة عقودًا من الخبرة إلى المشهد العقاري الديناميكي في الشرق الأوسط. محفظتنا المتنوعة والتزامنا الثابت بالجودة رسخ مكانتنا كاسم موثوق في مجال التطوير العقاري الفاخر.',
        teamOfExperts: {
          title: 'فريق من الخبراء',
          subtitle: 'مكرسون للتميز',
          description:
            'اربن لينز هي شركة متخصصة في جعل العالم مكانًا أكثر جمالاً. نعمل جنبًا إلى جنب مع شركاتنا الشقيقة في الكويت ومصر لمواصلة إرث استثمارات إميل عبد الله. معاييرنا وقيمنا موحدة مما يساعدنا في اربن لينز على تحقيق المزيد من قصص النجاح. فرقنا الفنية تحلم دائمًا بمشاريع جديدة ومثيرة للعمل عليها ولا نحب شيئًا أكثر من مشاركة إبداعاتهم مع العالم. لقد كنا موجودين لسنوات عديدة ونمونا لنصبح واحدة من أشهر الشركات في مجالنا. نسعى دائمًا للتميز ونحن واثقون من أنك ستجد عملنا ذو جودة عالية.',
        },
        artToArchitecture: {
        ...
        statistics: [
          { title: 'سنوات الخبرة', value: '36+' },
          { title: 'المشاريع المكتملة', value: '100+' },
          { title: 'الأبراج المسلمة', value: '20+' },
          { title: 'القوى العاملة', value: '3,600+' },
          { title: 'المشاريع البارزة', value: '60+' },
        ],
        stats: [
        ...
        values: [
          {
            ...
            description: 'نؤمن بأن معاييرنا العالية والتزامنا بالجودة هو ما يميزنا عن شركات التطوير العقاري الأخرى.',
          },
          {
            title: 'الالتزام',
            description:
              'تاريخنا المشهود وخبرتنا الواسعة تمنحنا الأفضلية في مواعيد التسليم. سجلت شركاتنا الشقيقة في الكويت سجلاً حافلاً في الالتزام بالمواعيد.',
          },
          {
            title: 'الموثوقية',
            description: 'أعادت اربن لينز تعريف تجربة العملاء في السوق وغيرت المفاهيم، بفضل الاجتهاد الخالص والتفاني في التميز.',
          },
          {
            title: 'المرونة',
        ...
        kuwaitProjects: [
          ...
          'بورتو السالمية',
          'برج برايم',
          'جامعة الجامعة الأمريكية بالشرق الأوسط',
          'برج الخالد',
          'معرض سيارات الكويت',
          'مدينة غرب عبد الله المبارك',
          'مجمع بيت التمويل الكويتي',
          'برج برستيج الفاخر للشقق',
          'ثلاثة مباني إدارية في حي الشروق، المعادي والمقطم',
        ],
      },
      projects: {
        'yellow-lane': {
    ...
    newsletter: {
      title: 'احصل على آخر الأخبار والتحديثات من اربن لينز',
      description: 'عن طريق الاشتراك توافق على تلقي بريد التسويق من اربن لينز واتعهد بالموافقة على سياسة الخصوصية الخاصة بنا!',
