      ...
      <div className="container">
        ...
        <AnimIn delay={0.3} className="space-y-6 text-center mt-12">
          ...
          <div className="space-y-4 font-light text-black/80 text-lg leading-relaxed">
            <p>
              ...
              actions and preferences (such as login, language, font size, and other display preferences) over a period of time.
            </p>
          </div>
        </AnimIn>
        ...
        <div className="space-y-16 mt-12">
            ...
            <div className="gap-8 grid md:grid-cols-2">
              {[
                ...
                <div key={i} className="bg-main/25 border rounded-2xl p-8">
                  ...
                  <p className="font-light">{cookie.desc}</p>
                </div>
              ))}
            </div>
          </AnimIn>
          ...
          <AnimIn delay={0.5} className="space-y-6">
            ...
            <p className="font-light text-lg mb-6">In some special cases we also use cookies provided by trusted third parties:</p>
          ...
          <AnimIn delay={0.6} className="space-y-6">
            ...
            <p className="font-light text-lg leading-relaxed">
              You can control and/or delete cookies as you wish. You can delete all cookies that are already on your computer and you can
