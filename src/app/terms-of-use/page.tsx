        ...
        <div className="space-y-16 mt-12">
          ...
          <AnimIn delay={0.5} className="space-y-6">
            ...
            <p className="font-light text-lg leading-relaxed">
              ...
              of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of
              rights.
            </p>
          </AnimIn>
          ...
          <AnimIn delay={0.6} className="space-y-6">
            ...
            <p className="font-light text-lg">
              In no event shall Urbnla suppliers be liable for any damages (including, without limitation, damages for loss of data or
              profit, or due to business interruption) arising out of the use or inability to use the materials on Urbnlanes&apos; website.
            </p>
          </AnimIn>
          ...
          <AnimIn delay={0.7} className="space-y-6">
            ...
            <p className="font-light text-lg">
              The materials appearing; website could include technical, typographical, or photographic errors. Urbnlanes does not warrant
