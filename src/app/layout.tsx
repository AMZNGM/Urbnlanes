  ...
  return (
    <html lang="en" className={`${fontMain.variable} ${cinzel.variable} ${fontArab.variable}`}>
      <body
        ...
        className="relative w-full h-full bg-text selection:bg-main/75 font-main text-text selection:text-text antialiased md:subpixel-antialiased uppercase scroll-smooth"
      >
