# 🏗️ Urbnlanes Developments — Portfolio & Web App
...
git clone https://github.com/AMZNGM/urbnlanes.git
...
├── components/     # UI Components (Hero, Projects, News, etc.)
├── config/         # Application Configuration
├── database/       # Mock/Data layers
